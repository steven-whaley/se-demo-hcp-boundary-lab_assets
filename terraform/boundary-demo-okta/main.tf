...
resource "boundary_role" "okta_dev_role" {
  ...
  grant_scope_ids = ["data.terraform_remote_state.boundary_demo_targets.outputs.dev_project_id"]
}
...
resource "boundary_role" "okta_pie_role" {
  ...
  grant_scope_ids = ["data.terraform_remote_state.boundary_demo_targets.outputs.pie_project_id'}"]
}
...
resource "boundary_role" "okta_it_role" {
  ...
  grant_scope_ids = ["data.terraform_remote_state.boundary_demo_targets.outputs.it_project_id"]
}
